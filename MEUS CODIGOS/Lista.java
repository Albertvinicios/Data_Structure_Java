public class Lista{
	...
	//contrutor é só o padrão, que é null
	//interesse só da lista, não teremos get e set.
	...
	public void insereInicio(int info){
		...
		if(!estaVazia()){
			novoNo.setProximo(primeiro); // primeiro é o topo
		}
			primeiro = novoNo; 
	}
	...
	public int removeFim(){
		if(estaVazia()){
			return -1;
		}else if(primeiro.getProximo() == null){ // tem um só valor
			int temp = primeiro.getInfo();
